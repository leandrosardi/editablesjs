...
editablesJs = {
	...
	draw: function(parent, h) {
		...
		"		<button class='edit-button btn btn-link simple menu-link'><i class='icon-pencil'> </i></a> " +
		"	</div> " +
		"	<div class='editable-field-editable'> " +
		"		<input class='editable-input' placeholder='"+h['placeholder'].toString()+"' /> " +
		"		<button class='save-button btn btn-blue'>Save</button> " +
		"		<button class='cancel-button btn btn-gray'>Cancel</button> " +
		"	</div> " +
		"</div> ";
